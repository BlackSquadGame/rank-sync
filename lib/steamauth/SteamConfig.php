...
// System stuff
if (empty($steamauth['apikey'])) {die("<div style='display: block; width: 100%; background-color: red; text-align: center;'>SteamAuth:<br>Please supply an API-Key!<br>Find this in config.php, Find the '<b>\$steamauth['apikey']</b>' Variable. </div>");}
